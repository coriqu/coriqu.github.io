...
const ProjectSection = (props) => {
	...
	<ProjectContainer className="project-box col-xl-6 col-md-6 col-xs-12 col-12" style={{backgroundColor: props.backgroundColor}}>
		<H2 style={{color: props.fontColor}}>0{props.index+1}</H2>
		<Link to={props.link}>
